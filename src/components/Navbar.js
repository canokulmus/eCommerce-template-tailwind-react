            ...
            <nav className='text-right'>
                ...
                <ul className={`text-sm mt-6 ${!isMenuOpen && "hidden"} md:block`}>
                    ...
                    <li className='py-1'>
                        <a href="#" className='px-4 flex justify-end border-r-4 border-white'>
                            <span>Login</span>
                            <svg class="custom-icon1 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        </a>
                    </li>
                    <li className='py-1'>
                        <a href="#" className='px-4 flex justify-end border-r-4 border-white'>
                            <span>Signup</span>
                            <svg class="custom-icon1 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path></svg>
                        </a>
                    </li>
                </ul>
            </nav>
